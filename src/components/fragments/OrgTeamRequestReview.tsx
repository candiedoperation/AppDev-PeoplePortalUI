        ...
        <DialogHeader>
          {loading ? (
            ...
            <>
              ...
              <DialogDescription>
                Review the details for the new team request from{' '}
        ...
        {loading ? (
                ...
                <Table>
                  <TableBody>
                    ...
                    <TableRow>
                      ...
                      <TableCell>
                        {request.createTeamRequest.seasonType}{' '}
                        {request.createTeamRequest.seasonYear}
                      </TableCell>
                    </TableRow>
                    <TableRow>
                      <TableCell className="font-bold w-1/4 align-top">Description</TableCell>
                      <TableCell className="whitespace-pre-wrap break-words">
                        {request.createTeamRequest.description}
                      </TableCell>
                    </TableRow>
                  </TableBody>
                </Table>
          ...
          <div className="py-4">
            <p className="text-muted-foreground">
              The request could not be found or has already been processed.
            </p>
          </div>
        )}
