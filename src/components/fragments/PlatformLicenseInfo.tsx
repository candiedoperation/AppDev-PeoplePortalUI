  ...
  return (
    <div className="flex flex-1 flex-col gap-4 pt-0 h-full">
      ...
      <div className="flex flex-col gap-4 flex-1 overflow-auto">
          ...
          <CardContent className="p-6 flex items-center gap-4">
            <div className="flex flex-grow-1 items-center gap-4">
              ...
              <div>
                ...
                <CardDescription>
                  Copyright © {new Date().getFullYear()} Atheesh Thirumalairajan
                </CardDescription>
              </div>
            </div>
            <LicenseModal
        ...
        <div
          className="grid grid-cols-1 md:grid-cols-2 gap-4 flex-1 min-h-0"
              ...
              <ScrollArea className="h-full w-full">
                <div className="flex flex-col divide-y">
                  {frontendDeps.map((dep: any, i) => (
                    <div
                      key={i}
                      className="flex items-center justify-between p-3 px-4 hover:bg-muted/50 text-sm"
                    >
